...
@section('img-background')
    <div class="page-header header-filter" data-parallax="true" style="background-image:url('{{asset('img/playstation2.jpg')}}');"></div>
@endsection

@section('content')
    div class="cover-author-content ">
    <img class="" src="{{$user->cover_image_url}}">
    </div>
        ...
        <div class="card card-body ml-auto mr-auto col-11 mb-5">
            <div class="row">
                ...
                <div class="col-10 mt-2 mt-xl-0 text-justify text-secondary ml-auto mr-auto p-2">
                    <i class="fas fa-user"></i> Autor: {{$user->username}}<br>
